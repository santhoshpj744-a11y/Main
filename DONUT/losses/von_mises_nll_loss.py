...
_I1_COEF_SMALL = [0.5, 0.87890594, 0.51498869,
                  0.15084934, 0.2658733e-1, 0.301532e-2, 0.32411e-3]
...
class VonMisesNLLLoss(nn.Module):
    ...
    def forward(self,
        ...
        nll = -conc * torch.cos(target - loc) + math.log(2 *
                                                         math.pi) + _log_modified_bessel_fn(conc, order=0)
